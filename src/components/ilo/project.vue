<template>
    <div class="card">
        <div class="top-upcoming">
            ...
            <div class="clearfix">
                <span style="cursor:pointer" class="name" @click="$emit('showModal', presaleData)">{{ presaleData.sale_token_name }}</span>
                <ul class="list" v-if="hasShowLinkSocial">
                    <li v-show="presaleData.telegram_url && presaleData.telegram_url != ''">
                    ...
                    <li v-show="presaleData.facebook_url && presaleData.facebook_url != ''">
                    ...
                    <li v-show="presaleData.discord_url && presaleData.discord_url != ''">
                    ...
                    <li v-show="presaleData.github_url && presaleData.github_url != ''">
                    ...
                    <li v-show="presaleData.twitter_url && presaleData.twitter_url != ''">
        ...
        <div class="body-upcoming">
            ...
            <p class="text-center mb-4" v-if="presaleData['current_status'] === 2">
                <a href="javascript:void(0)" class=" btn-style">
                    <img src="@/assets/images/icon-edit.svg" class="mr-1">
                    Success
                </a>
            </p>
            <p class="text-center mb-4" v-if="presaleData['current_status'] === 0 || presaleData['current_status'] === 1">
                <a href="javascript:void(0)" class=" btn-style btn-orange">
                    <img src="@/assets/images/time-upcoming.svg" alt="" class="mr-1">
                    Upcoming
                </a>
            </p>
            <p class="text-center mb-4" v-if="presaleData['current_status'] === 3">
                <a href="javascript:void(0)" class="btn-failed">
            ...
            <div class="box-gray">
                <ul class="list">
                    <li>
                        <span class="txtname">Total Raise</span>
                        <span class="f-Nunito fs-14 cl5D">{{ presaleData.usd_raised ? presaleData.usd_raised : '0.00' }} $</span>
                    </li>
                    <li>
                        <span class="txtname">Purchase Limit </span>
                        <span class="f-Nunito fs-14 cl5D">{{ presaleData.limit_per_buyer }} {{ presaleData.base_token_symbol }}</span>
                    </li>
                    <li class="mb-0">
                        <span class="txtname">Time</span>
                        <span class="f-Nunito fs-14 cl5D">{{ momentDate(presaleData.start_time * 1000,2) }}</span>
                    </li>
                    <li class="mb-0">
                        <span class="txtname">Price</span>
                        <span class="f-Nunito fs-14 cl5D">{{ formatPrice(1/presaleData.token_price, 5)}} {{ presaleData.base_token_symbol }}</span>
                    </li>
                </ul>
            </div>
        </div>
...
<!--            <div class="time-in d-flex">-->
<!--                <img src="@/assets/images/time-in.svg" class="mr-2">-->
<!--                <div class="clearfix">-->
<!--                    <span class="f-Nunito d-block fw-bold ">End in</span>-->
<!--                    <span class="f-Nunito fs-14 cl5D">48:00:00</span>-->
<!--                </div>-->
<!--            </div>-->
<!--            <div class="time-lissting d-flex">-->
<!--                <img src="@/assets/images/time-listing.svg" class="mr-2">-->
<!--                <div class="clearfix">-->
<!--                    <span class="f-Nunito d-block fw-bold ">Listing Time</span>-->
<!--                    <span class="f-Nunito fs-14 cl5D">48:00:00</span>-->
<!--                </div>-->
<!--            </div>-->
        </div>
